                ...
                <tr>
                    ...
                    <?php
                        ...
                        $bd = mysqli_select_db($connection, 'ebp');
                            $query= "SELECT min(id) AS id, UserId, Name, Fonction, DeptCode,Dates,Motif, COUNT(UserId) AS Nb_user
                            FROM t_present_jours WHERE Dates=DATE(NOW()) GROUP BY UserId HAVING COUNT(UserId)>=2";
