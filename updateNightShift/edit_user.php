...
if(isset($_POST["save"]) && $_POST["save"]!="") {
    ...
    for($i=0;$i<$usersCount;$i++) {
        ...
        $plage=$_POST['txtPlage'];
        $groupe=$_POST['txtGroupe'];
        if (empty($groupe)) {
            $query="UPDATE Userinfo SET  Plage_E='$plage', Groupe=NULL WHERE Userid='$matUser'";
            odbc_exec($connection, $query);
        }else{
            $query="UPDATE Userinfo SET  Plage_E='$plage', Groupe='$groupe' WHERE Userid='$matUser'";
            odbc_exec($connection, $query);
        }
                    ...
                    <table id="table_data" class="table table-striped table-bordered second" style="text-align: center;">
                        ...
                        <?php
                            ...
                            for($i=0;$i<$rowCount;$i++) {
                                $q="SELECT Userinfo.Userid AS Userid, Userinfo.Name AS Name, Format(Userinfo.Plage_E,'hh:mm:ss') AS Plage_E, (Userinfo.Groupe) AS Groupe 
