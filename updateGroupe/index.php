...
Format(Userinfo.Plage_E,'hh:mm:ss') AS Plage_E,Format(Userinfo.Plage_S,'hh:mm:ss') AS Plage_S, Userinfo.Groupe AS Groupe
    ...
    <?php include('../config/template/header.php'); ?>
        ...
        <form name="frmUser" method="post" action="">
            ...
            <div class="card-footer">
                <button class="btn btn-info" type="submit" name="update" onClick="setUpdateAction();">MISE A JOUR</button>
            </div>
        </form>
        </div>
        </div>
