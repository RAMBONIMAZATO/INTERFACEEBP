...
if(isset($_POST["save"]) && $_POST["save"]!="") {
    ...
    for($i=0;$i<$usersCount;$i++) {
        ...
        $id=$_POST["id"][$i];
        $comment=$_POST['txtCommentaire'];
        $query="UPDATE t_h_travail SET  Commentaire='$comment' WHERE id='$id'";
        ...
        <div class="card-body">
            <form name="frmUser" method="post" action="">
                    ...
                    <table id="table_data" class="table table-striped table-bordered second" style="text-align: center;">
                        ...
                        <?php
                            ...
                            for($i=0;$i<$rowCount;$i++) {
                                /*$id=;*/
                                $q="SELECT id, UserId, Name,Dates, H_travail,Commentaire FROM t_h_travail WHERE id='".$_POST["users"][$i]."'";
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="UserId[]" class="txtField" value="<?php echo $row[$i]['UserId']; ?>">
                            </td>
                            <td>
                                <input type="text" name="Name[]" class="txtField" value="<?php echo $row[$i]['Name']; ?>">
                            </td>
                            <td>
                                <input type="text" name="Dates[]" class="txtField" value="<?php echo $row[$i]['Dates']; ?>">
                            </td>
                            <td><input type="text" name="H_travail[]" class="txtField" value="<?php echo $row[$i]['H_travail']; ?>"></td>
                            <td><input type="text" name="Commentaire[]" class="txtField" value="<?php echo $row[$i]['Commentaire']; ?>"></td>
                        </tr>
                        <?php
                            }
                        ?>
                ...
                <div class="card-footer">
                        ...
                        <input type="text" name="txtCommentaire">
