    ...
    <div class="dashboard-main-wrapper">
       ...
       <?php include('../config/template/header.php'); ?>
        ...
        <div class="card-header">
            <h2 class="pageheader-title">Liste night shift</h2>
        ...
        <?php                         
            ...
            if (isset($_POST['search'])) {
                ...
                /*$query = "SELECT DISTINCT UserId, Name, Code, Obs
                            FROM t_absence_jours WHERE ((Dates BETWEEN '$txtStartDate' AND '$txtEndDate') AND Obs =  'night shift')";*/
                $query = "SELECT DISTINCT h.UserId AS UserId, h.Name AS Name, h.Fonction AS Fonction, h.H_entree AS H_sortie, h.H_sortie AS H_entree,h.H_travail AS H_travail,h.Dates AS Dates, m.Motif AS Motif FROM t_h_travail h RIGHT JOIN test_night_shift m ON h.UserId=m.Mat WHERE (h.Dates BETWEEN '$txtStartDate' AND '$txtEndDate') AND m.Motif='night shift'";
