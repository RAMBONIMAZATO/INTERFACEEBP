...
<head>
    ...
    <title>Liste autorisation d'absence</title>
    <!-- Bootstrap CSS -->
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Liste autorisation d'absence</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <?php  
                                            ...
                                            $q = "
                                            SELECT distinct UserId as UserId, Name,Fonction, Code, Dates, Obs
                                            FROM t_absence_jours WHERE (Dates=Date(now()) AND Obs='absence autorise') GROUP BY UserId";
