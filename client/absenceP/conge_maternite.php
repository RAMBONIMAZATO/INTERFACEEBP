...
<head>
    ...
    <title>Liste congé de maternité</title>
    <!-- Bootstrap CSS -->
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Liste congé de maternité</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <?php  
                                            ...
                                            FROM t_absence_jours WHERE (Dates=Date(now()) AND Obs='conge maternite') GROUP BY UserId";
