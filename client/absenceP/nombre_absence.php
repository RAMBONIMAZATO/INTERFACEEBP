...
<head>
    ...
    <title>Nombre d'absence employée</title>
    <!-- Bootstrap CSS -->
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Liste sans motif</h5>
                                </div>
                                <div class="card-body">
					        <form method="post">
					        	<div>
                                ...
                                <div class="card-body">
                                    ...
                                    <?php  
							            ...
							            if (isset($_POST['search'])) {
                                            ...
                                            $q = "
                                            SELECT UserId, Name,  Code, min(DISTINCT Dates) AS Dates_debut, max(DISTINCT Dates) AS Dates_fin ,COUNT(DISTINCT Dates) AS Nb_jours
                                            FROM t_absence_jours WHERE ((Dates BETWEEN '$txtStartDate' AND '$txtEndDate ') AND Obs IS NULL AND Code!='EXP' AND Code!='GNBR') GROUP BY UserId";
                                    ...
                                    ?>
                                        <table id="table_data" class="table table-striped table-bordered second" style="text-align: center;">
                                            <thead>
                                                <tr>
                                                    <th>Matricule</th><th>Nom et prénom</th><th>Departement</th><th>Nb. Jours</th><th>Debut</th><th>Fin</th>
                                                </tr>
                                            </thead>
                                        <?php 
                                        if (isset($_POST['search'])) {  
