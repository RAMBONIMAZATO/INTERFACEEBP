                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Pourcentage absence hebdomadaire</h5>
                                </div>
                                <div class="card-body">
                                <form method="post">
                                    <div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        if (isset($_POST['search'])) {
	    									...
	    									$q = "SELECT distinct DeptId AS DeptId, Code, Effectif, Dates, Nb_pres, Nb_abs, ROUND(P_abs,2) AS P_abs FROM t_abs_journalier WHERE Dates BETWEEN '$txtStartDate' AND '$txtEndDate'";
