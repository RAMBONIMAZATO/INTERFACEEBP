...
<head>
    ...
    <title>Liste absence journalier</title>
    <!-- Bootstrap CSS -->
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Liste absence journalier</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <?php 
                                            ...
                                            $l_abs_journalier = "SELECT distinct UserId AS UserId, Name, DeptId, Code, Effectif, Dates 
                                                                    FROM t_absence_journalier WHERE Dates=Date(now())";
                                            $r_abs_journalier = mysqli_query($connection, $l_abs_journalier);
                                        ...
                                        <?php 
                                            while ($row = mysqli_fetch_array($r_abs_journalier)) {
                                        ?>
                                                    <tr>
