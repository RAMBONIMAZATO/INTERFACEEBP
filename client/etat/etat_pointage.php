               ...
               <!--  <div class="row">
                    ...
                    <?php            
                        ...
                        if (isset($_POST['search_jours'])) {
                            ...
                            $query = "SELECT DISTINCT UserId, Name, Fonction, DeptId, Code, Dates, H_entree, H_sortie, P_entree, H_Retard, H_travail
                                        FROM t_h_travail WHERE (Dates BETWEEN '$txtStartDate' AND '$txtEndDate') AND (UserId='$txtUser') GROUP BY UserId, Dates";
                ...
                <!-- ============================================================== -->
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="mb-0">État de pointage jours</h2>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="btn btn-primary" type="submit" name="search_jours">SHOW</button>
                                                    </td>
                                ...
                                <div class="card-body">
                                    <table id="table_data_jours" class="table table-striped table-bordered second" style="text-align: center;">
                                        <thead>
                                            <tr>
                                                <th>N° Mat</th>
                                                <th>Nom et Prénom</th>
                ...
                <div class="row">
                    <?php            
                        $connection = mysqli_connect("localhost", "root", "");
                        $bd = mysqli_select_db($connection, 'ebp');
                        if (isset($_POST['search_nuit'])) {
                            $txtUser = $_POST['txtUser'];
                            $txtStartDate = $_POST['txtStartDate'];
                            $txtEndDate = $_POST['txtEndDate'];
                            $query = "SELECT DISTINCT UserId, Name, Fonction, DeptId, Code, Dates, H_entree, H_sortie, H_travail
                                        FROM t_h_nuit WHERE (Dates BETWEEN '$txtStartDate' AND '$txtEndDate') AND (UserId='$txtUser')";
                            $r_query = mysqli_query($connection, $query);
                        }
                    ?>
                <!-- ============================================================== -->
                ...
                <!-- ============================================================== -->
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="mb-0">État de pointage nuit</h2>
                                    <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p></div>
                                <div class="card-header">
                                    <form method="post">
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label>Affichage : </label>
                                                        <button class="btn btn-primary" type="submit" name="search_nuit">SHOW</button>
                                                    </td>
                                ...
                                <div class="card-body">
                                    <table id="table_data_nuit" class="table table-striped table-bordered second" style="text-align: center;">
                                        <thead>
                                            <tr>
                                                <th>N° Mat</th>
                                                <th>Nom et Prénom</th>
