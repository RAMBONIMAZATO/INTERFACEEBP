                                                ...
                                                <tr>
                                                    <td>                                            
                                                        ...
                                                        <select   name="txtCode"  id="txtCode" onchange="showUser(this.value)">
                                                            ...
                                                            <option value="67">LN16</option><option value="68">GNBR</option><option value="69">LN17</option><option value="70">BDRJ</option><option value="71">CPEJ</option><option value="72">CPLJ</option><option value="73">LVGJ</option><option value="74">MNTJ</option><option value="75">MECJ</option><option value="76">MROJ</option><option value="77">SMPJ</option><option value="78">STRJ</option><option value="79">DPRJ</option><option value="80">FNTJ</option><option value="81">GNRJ</option><option value="82">ADMJ</option>
                                                        </select>
                                                    </td>
                                                    <td>
                                                            <div id="txtHint">
