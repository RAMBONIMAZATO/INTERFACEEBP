...
<head>
    ...
    <title>Etat de pointage permanant</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="dashboard-main-wrapper">
       ...
       <?php include('../config/template/header.php'); ?>
        ...
        <div class="card-header">
            <h2 class="pageheader-title">Liste etat permanant</h2>
        ...
        <?php                         
            ...
            if (isset($_POST['search'])) {
                ...
                /*$query = "SELECT e.UserId AS UserId, e.Name AS Name, e.Fonction AS Fonction, e.Dates AS Dates, e.H_entree AS H_entree, s.H_sortie AS H_sortie
                ...
                /*FARANY*/
                /* $query = "SELECT distinct UserId, Name, Fonction, Code, Dates, max(H_entree) AS H_entree, min(H_sortie) AS H_sortie, P_entree, Pause, H_travail
                FROM t_h_nuit WHERE Dates ='$txtStartDate' GROUP BY UserId";*/
                /*FARANY*/
                $query = "SELECT distinct UserId, Name, Fonction, Code, Dates, max(H_entree) AS H_entree, min(H_sortie) AS H_sortie, P_entree, H_travail
                FROM t_h_nuit WHERE Dates ='$txtStartDate' GROUP BY UserId";
