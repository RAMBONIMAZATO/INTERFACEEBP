                                    ...
                                    <div class="table-responsive">
                                        <?php  
                                            ...
                                            $q = "
                                                ...
                                                FROM t_h_ferie WHERE Dates='$StartDates'";
                                            /*$q="SELECT UserId, Name, min(Code) AS Code,min(DISTINCT Dates) AS Dates_debut, max(DISTINCT Dates) AS Dates_fin,count(H_conge) AS Nb_conge, count(H_repos) AS Nb_repos, count(H_permission) AS Nb_permission, count(H_autoabs) AS Nb_autoabs, count(H_commission) AS Nb_commission, count(H_miseapied) AS Nb_miseapied FROM `t_jours_nuit` WHERE (Dates BETWEEN '$StartDates' AND '$EndDates') GROUP BY UserId, Name";*/
