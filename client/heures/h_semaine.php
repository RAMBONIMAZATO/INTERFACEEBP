                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <div></div>
                            <h2 class="pageheader-title">Liste heures de travail semaine </h2>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <?php  
                                           $connection = mysqli_connect("localhost", "root", "");
                                            ...
                                            if (isset($_POST['search'])) {
                                                ...
                                                $txtEndDate = $_POST['txtEndDate'];
                                                $travail = "
                                                SELECT UserId, Name, Fonction, Code, MIN( Dates ) AS Dates_debut, ABS( DATEDIFF( MIN( Dates ) , MAX( Dates ) ) ) AS Nb_jours, WEEK( Dates ) AS Semaine, SEC_TO_TIME( SUM(DISTINCT TIME_TO_SEC( H_travail ) ) ) AS H_semaine FROM t_h_travail WHERE (Dates BETWEEN  '$txtStartDate' AND  '$txtEndDate')
                                                GROUP BY UserId, Name";
                                                $r_travail = mysqli_query($connection, $travail);
                                            }
                                        ?>
                                        ...
                                        <?php 
                                        if (isset($_POST['search'])) {
                                            while ($row = mysqli_fetch_array($r_travail)) {
                                        ?>
                                                    <tr>
