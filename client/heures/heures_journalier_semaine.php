                                    ...
                                    <div class="table-responsive">
                                        <?php  
                                           $connection = mysqli_connect("localhost", "root", "");
                                            ...
                                            $q="SELECT UserId, Name,  Code, Dates_debut, Nb_jours, H_semaine_jours
                                                FROM t_semaine_jours_nuit 
                                                WHERE (Dates_debut='$StartDates') AND 
                                                (Code='BDRJ' OR Code='CPEJ' OR Code='CPLJ' OR Code='LVGJ' OR Code='MNTJ' OR Code='MECJ' OR Code='MROJ' OR Code='SMPJ' OR Code='STRJ' OR Code='DPRJ' OR Code='FNTJ' OR Code='GNRJ' OR Code='ADMJ') ";
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row["H_semaine_jours"]; ?></td>
                                                    </tr>
                                        <?php
                                            	}
                                            }
