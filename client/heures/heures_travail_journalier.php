                                    ...
                                    <div class="table-responsive">
                                        <?php  
                                           $connection = mysqli_connect("localhost", "root", "");
                                            ...
                                            $q = "
                                                SELECT DISTINCT `UserId`, `Name`, `Fonction`, `Code`, `Dates`, `H_entree`, `H_sortie`, `H_travail`
                                                FROM t_h_travail WHERE Dates='$StartDates' AND (Code='BDRJ' OR Code='CPEJ' OR Code='CPLJ' OR Code='LVGJ' OR Code='MNTJ' OR Code='MECJ' OR Code='MROJ' OR Code='SMPJ' OR Code='STRJ' OR Code='DPRJ' OR Code='FNTJ' OR Code='GNRJ' OR Code='ADMJ') ";
