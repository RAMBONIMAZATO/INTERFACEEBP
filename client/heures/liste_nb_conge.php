...
<head>
    ...
    <title>Nombres des congés</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <div></div>
                            <h2 class="pageheader-title">Liste des nombres des congés </h2>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <?php  
                                            ...
                                            /*$q = "
                                                SELECT UserId, Name, Code, Dates_debut, Nb_jours, Num_semaine, H_jours,H_conge,H_repos, H_permission, H_autoabs, H_commission, H_miseapied, H_total, H_brut, HS30 , HS50, HS60, H_abs, H_nuit, H_ferie, H_dimanche
                                                FROM t_h_supp";*/
                                            $q="SELECT UserId, Name, min(Code) AS Code,min(DISTINCT Dates) AS Dates_debut, max(DISTINCT Dates) AS Dates_fin,count(H_conge) AS Nb_conge, count(H_repos) AS Nb_repos, count(H_permission) AS Nb_permission, count(H_autoabs) AS Nb_autoabs, count(H_commission) AS Nb_commission, count(H_miseapied) AS Nb_miseapied FROM `t_jours_conge` WHERE (Dates BETWEEN '$StartDates' AND '$EndDates') GROUP BY UserId, Name";
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row["Nb_conge"]; ?></td>
                                                        <td><?php echo $row["Nb_repos"]; ?></td>
                                                        <td><?php echo $row["Nb_permission"]; ?></td>
                                                        <td><?php echo $row["Nb_autoabs"]; ?></td>
                                                        <td><?php echo $row["Nb_commission"]; ?></td>
                                                        <td><?php echo $row["Nb_miseapied"]; ?></td>
                                                    </tr>
                                        <?php
                                            }
                                        }
