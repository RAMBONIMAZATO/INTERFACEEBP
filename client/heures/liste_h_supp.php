                                    ...
                                    <div class="table-responsive">
                                        <?php  
                                            ...
                                            if (isset($_POST['search'])) {
                                                ...
                                                $q = "
                                                    SELECT UserId, Name, Code, Dates_debut, Dates_fin, Nb_jours, Semaine, H_semaine, HS_brut, HS30 , HS50, HS60, Abs_heures
                                                    FROM t_h_semaine WHERE Semaine=WEEK('$StartDates')";
