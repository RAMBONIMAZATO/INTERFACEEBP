...
<body>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Insertion multiple</h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="table_data" class="table table-striped table-bordered second" style="text-align: center;">
                                                <tr>
                                                    ...
                                                    <tr>
                                                        <td><input class="form-control" type="text" name="Matricule"></td>
                                                        <td><input class="form-control" type="text" name="Departement"></td>
                                                        <td><input class="form-control" type="text" name="Dates"></td>
                                                        <td><input class="form-control" type="text" name="Entree"></td>
                                                        <td><input class="form-control" type="" name="Sortie"></td>
                                                        <td><input class="form-control" type="text" name="Pause"></td>
                                                        <td><input class="form-control" type="text" name="Travail"></td>
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
        	var html= '<tr><td><input class="form-control" type="text" name="Matricule"></td><td><input class="form-control" type="text" name="Departement"></td><td><input class="form-control" type="text" name="Dates"></td><td><input class="form-control" type="text" name="Entree"></td><td><input class="form-control" type="" name="Sortie"></td><td><input class="form-control" type="text" name="Pause"></td><td><input class="form-control" type="text" name="Travail"></td><td><input class="btn btn-danger" type="button" name="remove" value="Remove"></td></tr>';
        	var x = 1;
