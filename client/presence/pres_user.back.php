...
<head>
    ...
    <title>Etat de pointage d'un employée</title>
    <!-- Bootstrap CSS -->
       ...
       <?php include('../config/template/header.php'); ?>
        ...
        <!-- ============================================================== -->
        	...
        	<div class="card-header">
                <h2 class="pageheader-title">Etat employée</h2>
                ...
                <div class="row">
                    <?php            
                        ...
                        if (isset($_POST['search'])) {              
                            ...
                            $query = "SELECT UserId, Name, Fonction, Code, Dates, H_entree, H_sortie, P_entree, H_Retard
                                        FROM t_h_travail WHERE (Dates BETWEEN '$txtStartDate' AND '$txtEndDate') AND (UserId='$txtUser') AND (Code='$txtCode')";
                                ...
                                <div class="card-header">
                                    <form method="post">
                                    	<div>
                                            ...
                                            <select name="txtCode" id="txtCode">
                                            ...
                                            ?>
                                            <option value="<?php echo $ligne["Code"]; ?>"><?php echo $ligne["Code"]; ?></option>
