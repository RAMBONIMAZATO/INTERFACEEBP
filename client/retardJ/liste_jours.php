        ...
        <div class="card-body">
            <div class="table-responsive">
                <?php  
                    ...
                    $ret_journalier = "SELECT UserId,  Code, H_E, P_E, H_ret, Dates FROM t_retard_journalier WHERE (Dates=Date(now())) AND (Code!='STC') ORDER BY UserId";
                    $retard_journalier = mysqli_query($connection, $ret_journalier); 
                ?>
                ...
                <?php 
                    while ($row = mysqli_fetch_array($retard_journalier)) {
                ?>
                            <tr>
