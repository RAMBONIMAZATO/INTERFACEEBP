        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                if (isset($_POST['search'])) { 
                    ...
                    $query = "SELECT DISTINCT DeptId AS DeptId, Code, Effectif, Nb_Ret, ROUND(P_Ret, 2) AS P_Ret, Dates 
                                    FROM t_pourcentage_retard_journalier WHERE Dates BETWEEN '$txtStartDate' AND '$txtEndDate' GROUP BY DeptId";
