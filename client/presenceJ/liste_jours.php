...
<head>
    ...
    <title>Etat de pointage journalier</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="dashboard-main-wrapper">
       ...
       <?php include('../config/template/header.php'); ?>
        ...
        <div class="card-header">
            <h2 class="pageheader-title">Liste etat journalier</h2>
        ...
        <?php                         
                ...
                $query = "SELECT UserId, Name, Fonction, Code, Dates, H_E
                            FROM t_heures_journalier WHERE Dates=Date(now())";
        ...
        ?>
                ...
                <!-- ============================================================== -->
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <!-- <div class="card-header">
                                    <h5 class="mb-0">État journalier</h5>
                                </div> -->
                                <div class="card-body">
