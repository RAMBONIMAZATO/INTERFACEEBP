...
$query="SELECT Checkinout.Logid AS Logid, Checkinout.Userid AS Userid, ANOMALIES_POINTAGE.Name AS Name, ANOMALIES_POINTAGE.Duty AS Fonction, ANOMALIES_POINTAGE.Dept AS Dept, 
Format(DateValue(Checkinout.CheckTime),'yyyy-mm-dd') AS Dates, Format(TimeValue(Checkinout.CheckTime), 'hh:mm:ss') AS Heures, ANOMALIES_POINTAGE.Nb_Pointage AS Nb_Pointage 
