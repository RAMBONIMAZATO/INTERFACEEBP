            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="update_periodique.php" method="POST">
                            <input type="hidden" name="update_id" id="update_id">
                            <div class="form-group">
                                <label for="UserId">Dept:</label>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="mb-0">LISTE D'ABSENCE PERIODIQUE</h3>
                                </div>
						        <div class="card-body">
    						        <form method="post">
    						        	<div class="card-header">
                                    ...
                                    <div class="table-responsive">
                                        <?php  
                                            ...
                                            if (isset($_POST['search'])) {
	                                            ...
	                                            $query = "SELECT id, UserId, DeptId, Code, Dates, Obs, Dates_fin
	                                            			FROM t_absence_jours WHERE (Dates='$txtStartDate') AND (Code!='GNBR') AND (Code!='EXP')";
	                                            $query_run = mysqli_query($connection, $query);
                                            }elseif (isset($_GET['Dates'])) {
                                                $dates=$_GET['Dates'];
                                                $query1 = "SELECT id, UserId, DeptId, Code, Dates, Obs, Dates_fin
                                                            FROM t_absence_jours WHERE (Dates='$dates') AND (Code!='GNBR') AND (Code!='EXP')";
