        ...
        <?php
                                        ...
                                        ?>        
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="l_conge.php"><?php  echo $c["c"]; ?></a>
                                                    <?php
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="l_cm.php"><?php echo $cm["cm"]; ?></a>
                                                    <?php
                                                        }
                                                    ?>
                                                </td>
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="l_aa.php"><?php echo $aa["aa"]; ?></a>
                                                    <?php 
                                                        }
                                                    ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="l_com.php"><?php echo $com["com"]; ?></a>
                                                    <?php  
                                                        }
                                                    ?>
                                                </td>
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="l_susp.php"><?php echo $susp["susp"]; ?></a>
                                                    <?php 
                                                        }
                                                    ?>
                                                </td>
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="l_rm.php"><?php echo $rm["rm"]; ?></a>
                                                    <?php 
                                                        }
                                                    ?>
                                                </td>
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="l_recup.php"><?php echo $recup["recup"]; ?></a>
                                                    <?php 
                                                        }
                                                    ?>
                                                </td>
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="l_hp.php"><?php echo $hp["hp"]; ?></a>
                                                    <?php 
                                                        }
                                                    ?>
                                                </td>
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="l_map.php"><?php echo $map["map"]; ?></a>
                                                    <?php 
                                                        }
                                                    ?>
                                                </td>
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="l_nf.php"><?php echo $l["nf"]; ?></a>
                                                    <?php 
                                                        }
                                                    ?>
                                                </td>
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="l_sm.php"><?php echo $sm["sm"]; ?></a>
                                                    <?php 
                                                        }
                                                    ?>
                                                </td>
