...
$query= "SELECT Userinfo.Userid AS Userid, Userinfo.Name AS Name, Userinfo.Duty AS Duty, Userinfo.Deptid AS Deptid, Dept.DeptName AS Code, Format(Userinfo.Plage_E, 'hh:mm:ss') AS Plage_E, 
Format(Userinfo.Plage_S,'hh:mm:ss') AS Plage_S, Userinfo.Groupe AS Groupe
FROM Userinfo, Dept WHERE  ((Userinfo.Deptid)=(Dept.Deptid)) AND  ((Userinfo.Groupe)='L') AND 
((Userinfo.Deptid)<>65)";
