                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <?php  
                                            ...
                                            /*$q="SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, '$StartDates' AS Dates
			                                FROM t_dept_journalier 
			                                WHERE UserId NOT IN (SELECT DISTINCT UserId FROM t_presence_journalier WHERE Dates = '$StartDates')";*/

			                                /*$q="SELECT d.UserId AS UserId, d.Name AS Name, d.DeptId AS DeptId, d.Code AS Code, d.Effectif AS Effectif, '$StartDates' AS Dates
			                                FROM t_dept_journalier d LEFT JOIN t_presence_journalier p ON d.UserId=p.UserId AND p.Dates='$StartDates' WHERE p.Dates IS NULL";*/

			                                $q="SELECT DISTINCT UserId, Name, DeptId, Code, Effectif,'$StartDates' AS Dates
                                            FROM t_dept_user WHERE UserId NOT IN (SELECT DISTINCT UserId FROM t_present_jours WHERE (Dates='$StartDates' AND Motif IS NULL))";

                                            /*$q="SELECT d.UserId AS UserId, d.Name AS Name, d.DeptId AS DeptId, d.Code AS Code, d.Effectif AS Effectif, '$StartDates' AS Dates
			                                FROM t_dept_user d LEFT JOIN t_present_jours p ON d.UserId=p.UserId AND p.Dates='$StartDates' WHERE p.Dates IS NULL AND p.Motif IS NULL";*/
