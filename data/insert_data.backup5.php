...
<!-- ######################################################################################################################################################### -->
					<div class="row">       
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">INSERTION CONGE CONSECUTIF</h5>
                                <div class="card-body">
                                	<form method="post">
                                        <table>
                                            <thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label> <div></div></label>
                                                        <label>Jour-1 du congé : </label>
                                                        <input type="date" name="txtStartDate">
                                                    </td>
                                                    <td>
                                                        <label> <div></div></label>
                                                        <label>Jour fin du congé : </label>
                                                        <input type="date" name="txtEndDate">
                                                    </td>
                                                    <td>
                                                        <label>Insertion :</label>
                                                        <button class="btn btn-info" type="submit" name="search">Affiche</button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>           
...
<!-- ######################################################################################################################################################### -->
                    ...
                    <?php  
                        ...
                        if (isset($_POST['btn_pourcentage'])) {
                            ...
                            /*fin night shift*/
                            if($r_insert_p_abs && $r_q_travail_employee && $r_q_update_entree_sortie && $r_entre_sortie && $r_q_update_pause && $r_q1 && $r_q2 && $r_q3 && $r_q4){
...
############################################ HEURES NIGHT SHIFT###################################################################################
                    if (isset($_POST['btn_sup_motif'])) {
                        ...
                        if($r_qmotif && $r_qconge && $r_qcongemat && $r_qrepmed && $r_qabsauto && $r_qpermission && $r_qsuspendu && $r_qrecup && $r_qcomission && $r_qhospitalise && 
...
############################################END HEURES NIGHT #####################################################################################
                    ...
                    <div class="row">       
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">MOTIFICATION APRES VERIFICATION DES SANS MOTIF</h5>
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" action="insert_data.php" method="post">
                                        <label>Date : </label>
                                        <input type="date" name="SuprDate">
                                        <label>SUPPRESSION :</label>
                                        <button class="btn btn-info" type="submit" name="btn_sup_motif">SUPRIMER</button>
                                    </form>
                                </div>
                            </div>
                        </div>
