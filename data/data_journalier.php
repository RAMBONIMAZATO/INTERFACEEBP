        ...
        <!-- ============================================================== -->
                <div class="container-fluid dashboard-content ">
                    ...
                    if (isset($_POST['btn_delete'])) {
                        $delete1="DELETE FROM t_present_jours WHERE Dates=Date(now())";
                        $r_delete1 = mysqli_query($connection, $delete1);
                        $delete2="DELETE FROM t_presence_journalier WHERE Dates=Date(now())";
                        $r_delete2 = mysqli_query($connection, $delete2);
                        $delete3="DELETE FROM t_pres_h_jours WHERE Dates=Date(now())";
                        $r_delete3 = mysqli_query($connection, $delete3);
                        $delete4="DELETE FROM  t_heures_journalier WHERE Dates=Date(now())";
                        $r_delete4 = mysqli_query($connection, $delete4);
                        $delete5="DELETE FROM t_h_e_s WHERE Dates='2020-11-30'";
                        $r_delete5 = mysqli_query($connection, $delete5);

                        $delete6="DELETE FROM t_retard_journalier WHERE Dates=Date(now())";
                        $r_delete6 = mysqli_query($connection, $delete6);
                        $delete7="DELETE FROM t_pourcentage_retard_journalier WHERE Dates=Date(now())";
                        $r_delete7 = mysqli_query($connection, $delete7);
                        $delete8="DELETE FROM t_absence_journalier WHERE Dates=Date(now())";
                        $r_delete8 = mysqli_query($connection, $delete8);

                        $delete9="DELETE FROM t_retard_jours WHERE Dates=Date(now())";
                        $r_delete9 = mysqli_query($connection, $delete9);
                        $delete10="DELETE FROM t_pourcentage_retard WHERE Dates=Date(now())";
                        $r_delete10 = mysqli_query($connection, $delete10);
                        $delete11="DELETE FROM t_absence_jours WHERE Dates=Date(now())";
                        $r_delete11 = mysqli_query($connection, $delete11);
                        if($r_delete1 && $r_delete2 && $r_delete3 && $r_delete4 && $r_delete5 && $r_delete6 && $r_delete7 && $r_delete8 && $r_delete9 && $r_delete10 && $r_delete11){
                    ...
                    ?>
                     <div class="row">       
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">COLLECTIOIN DES DONNÉES TEST</h5>
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" action="data_journalier.php" method="post">
                    ...
                    <?php 
                        ...
                        if (isset($_POST['update_btn_1'])) {
                            $q_update=" UPDATE t_retard_journalier  
                                        SET P_E=(
                                        CASE
                                           WHEN Code='GNRJ' THEN '06:00:00'
                                           WHEN Code='ADMJ' THEN '08:00:00'
                        ...
                        if (isset($_POST['insert_btn_4'])) {
                            $insert_p_abs="INSERT INTO `t_abs_journalier`(DeptId, Code, Effectif, Dates, Nb_pres, Nb_abs, P_abs) 
                                    SELECT DISTINCT DeptId as DeptId, DeptCode as Code, DeptEff as Effectif, Dates, COUNT( UserId ) as Nb_pres , (
                                    DeptEff - COUNT( distinct(Userid) )
                                    ) as Nb_abs, ((
                                    DeptEff - COUNT( distinct(Userid) )
                       ...
                       ################  INSERTION MOTIF JOURS ###############################################################
                        ...
                        if (isset($_POST['insert_btn_17'])) {
                            $q = "INSERT INTO nightshift(DeptId, Code, Dates, NF) 
                                  SELECT DISTINCT DeptId as DeptId, Code,Dates, count(UserId) as NF FROM t_absence_jours WHERE Obs IS NULL AND Dates=DATE(NOW()) GROUP BY DeptId
                                ";
                            $r_q = mysqli_query($connection, $q);
                            if ($r_q) {
