                    ...
                    <?php  
                        ...
                        if (isset($_POST['btn_journalier'])) {
                            ...
                            $q_retard_journalier = "
                                ...
                                WHERE ((Dates='$StartDate' ) AND (Code!='ADMJ')AND (Code!='GNRJ') AND (H_E BETWEEN  '07:05:00' AND  '10:00:00'))
                                UNION DISTINCT
                                SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, Dates, H_E
                                FROM  `t_heures_journalier` 
                                WHERE ((Dates='$StartDate' ) AND ( Code='ADMJ' ) AND (H_E BETWEEN  '08:05:00' AND  '10:00:00'))
                                UNION DISTINCT
                                SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, Dates, H_E
                                FROM  `t_heures_journalier` 
                                WHERE ((Dates='$StartDate' ) AND (Code='GNRJ') AND (H_E BETWEEN  '06:05:00' AND  '10:00:00'))";
                            ...
                            $q_update_journalier = "
                                ...
                                CASE
                                   ...
                                   ELSE '07:00:00'
                                END),
                                H_Ret=abs(TIMEDIFF(H_E, P_E))  WHERE Dates='$StartDate'";
                            ...
                            $q_pourcentage_retard_journalier = "
                                ...
                                FROM t_retard_journalier WHERE Dates='$StartDate' GROUP BY DeptId";
                            ...
                            $q_absence_journalier = "
                                ...
                                SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, '$StartDate' AS Dates
                                FROM t_dept_journalier 
                                WHERE UserId NOT IN (SELECT DISTINCT UserId FROM t_presence_journalier WHERE Dates = '$StartDate'";
                            ...
                            $q_pourcentage_absence_journalier = "
                                ...
                                FROM  `t_presence_journalier` WHERE Dates='$StartDate' GROUP BY DeptId ";
                            ...
                            $insert_l_ret="
                                    ...
                                    SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, Dates, H_E
                                    FROM  `t_pres_h_jours` 
                                    WHERE ((Dates='$StartDate') AND (Code != 'ADM')AND (Code != 'GNR') AND (H_E BETWEEN  '07:05:00' AND  '10:00:00'))
                                    UNION DISTINCT
                                    SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, Dates, H_E
                                    FROM  `t_pres_h_jours` 
                                    WHERE ((Dates='$StartDate') AND ( Code ='ADM' ) AND (H_E BETWEEN  '08:05:00' AND  '10:00:00'))
                                    UNION DISTINCT
                                    SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, Dates, H_E
                                    FROM  `t_pres_h_jours` 
                                    WHERE ((Dates='$StartDate') AND (Code ='GNR') AND (H_E BETWEEN  '06:05:00' AND  '10:00:00'))
                                    ";
                            ...
                            $pourcentage_retard_permanant = "
                                            ...
                                            SELECT  DISTINCT DeptId, Code, Effectif, count(UserId) as Nb_ret, (count(UserId)*100/Effectif) AS P_ret, Dates 
                                            FROM t_retard_jours WHERE Dates='$StartDate' GROUP BY DeptId
                                            ";
