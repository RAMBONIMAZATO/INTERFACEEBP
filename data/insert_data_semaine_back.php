...
#########################################LIER DEUX TABLES t_h_nuit et t_h_travail#############################################################################
        if (isset($_POST['btn_jours_nuit'])) {
            ...
            FROM t_dept_user t
            LEFT JOIN t_h_travail j ON t.UserId = j.UserId AND j.Dates='$DateBegin' 
...
SELECT t.UserId AS UserId, t.Name AS Name, t.Fonction AS Fonction, t.DeptId AS DeptId, t.Code AS Code, j.Dates AS Dates, j.H_travail AS H_jours, n.H_travail AS H_nuit
FROM t_dept_user t
LEFT JOIN t_h_travail j ON t.UserId = j.UserId AND j.Dates='2021-01-04' 
LEFT JOIN t_h_nuit n ON t.UserId=n.UserId AND j.Dates=n.Dates
WHERE j.Dates='2021-01-04' AND n.H_travail IS NOT NULL GROUP BY t.UserId, t.Name";

$q_f_n="INSERT INTO t_jours_nuit(UserId, Name, DeptId, Code, Dates, H_ferie, H_nuit)
SELECT t.UserId AS UserId, t.Name AS Name, t.Fonction AS Fonction, t.DeptId AS DeptId, t.Code AS Code, j.Dates AS Dates, j.H_travail AS H_ferie, n.H_travail AS H_nuit
FROM t_dept_user t
LEFT JOIN t_h_travail j ON t.UserId = j.UserId AND j.Dates='2021-01-04' 
LEFT JOIN t_h_nuit n ON t.UserId=n.UserId AND j.Dates=n.Dates
WHERE j.Dates='2021-01-04' AND n.H_travail IS NOT NULL GROUP BY t.UserId, t.Name";

$q_d_n="INSERT INTO t_jours_nuit(UserId, Name, DeptId, Code, Dates, H_dimanche, H_nuit)
SELECT t.UserId AS UserId, t.Name AS Name, t.Fonction AS Fonction, t.DeptId AS DeptId, t.Code AS Code, j.Dates AS Dates, j.H_travail AS H_dimanche, n.H_travail AS H_nuit
FROM t_dept_user t
LEFT JOIN t_h_travail j ON t.UserId = j.UserId AND j.Dates='2021-01-04' 
LEFT JOIN t_h_nuit n ON t.UserId=n.UserId AND j.Dates=n.Dates
WHERE j.Dates='2021-01-04' AND n.H_travail IS NOT NULL GROUP BY t.UserId, t.Name";
