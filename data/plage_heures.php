            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="update_plage.php" method="POST">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <?php  
                                            $con = odbc_connect("mklen", "", "");
                                            $query ="SELECT Userinfo.Userid AS Userid, Userinfo.Name AS Name, Userinfo.Plage_E AS Plage_E FROM Userinfo WHERE ((Userinfo.Deptid)<>65)";
