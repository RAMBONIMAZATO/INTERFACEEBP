                    ...
                    <?php  
                        ...
                        if (isset($_POST['btn_pourcentage'])) {
                            ...
                            /*$q_travail_employee="INSERT INTO t_h_travail(UserId, Name, Fonction, DeptId, Code, Effectif, Dates, H_entree, H_sortie, P_entree, P_sortie, H_travail)
                                ...
                                END) AS P_sortie,
                                H_travail
                                FROM t_h_e_s WHERE Dates='$StartDatePourcentage'
                                ";
                           ...
                           /* $q_update_entree_sortie=" UPDATE t_h_travail 
                                        ...
                                        WHERE SIGN(TIMEDIFF(H_entree, P_entree))>0 AND Dates='$StartDatePourcentage'
                                        ";
                            ...
                            /*$entre_sortie = "UPDATE t_h_travail SET H_travail=(CASE
                                    ...
                                    END) WHERE Dates='$StartDatePourcentage'";         
                            $r_entre_sortie = mysqli_query($connection, $entre_sortie); */


                            /**/
                            /*$q_update_pause=" UPDATE t_h_travail SET Pause=(CASE WHEN H_entree!=H_sortie THEN '00:45:00' END) WHERE Dates='$StartDatePourcentage'";
                            $r_q_update_pause = mysqli_query($connection, $q_update_pause);

                            $q_update_travail_pause=" UPDATE t_h_travail SET H_travail=TIMEDIFF(H_travail, Pause) WHERE Dates='$StartDatePourcentage'";
                           ...
                           /* $q1 = "INSERT INTO t_h_nuit(UserId, Name, Fonction, DeptId, Code, Dates, H_entree, H_sortie)
	                        ...
	                        WHERE e.Dates ='$StartDatePourcentage' AND s.Dates='$EndDatePourcentage'";
	                        $r_q1 = mysqli_query($connection, $q1);*/

	                        /*$q2= "UPDATE t_h_nuit SET Pause='01:00:00' WHERE Dates='$DateBegin'";*/
	                        /*$q2= "UPDATE t_h_nuit SET Pause='00:00:00' WHERE Dates='$StartDatePourcentage'";
	                        $r_q2 = mysqli_query($connection, $q2);
	                        
	                        $q3="UPDATE t_h_nuit SET P_entree='22:00:00' WHERE Dates='$StartDatePourcentage'";
	                        ...
	                        $q4="UPDATE t_h_nuit SET H_travail=(CASE WHEN H_entree <= P_entree THEN TIMEDIFF(ADDTIME(TIMEDIFF(H_sortie, P_entree), '24:00:00'), Pause) 
	                            WHEN H_entree > P_entree THEN TIMEDIFF(ADDTIME(TIMEDIFF(H_sortie, H_entree), '24:00:00'), Pause) END) WHERE Dates='$StartDatePourcentage'";
	                        $r_q4 = mysqli_query($connection, $q4);*/
                            /*fin night shift $r_insert_p_abs  && $r_q_travail_employee && $r_q_update_entree_sortie && $r_entre_sortie && $r_q_update_pause && $r_q1 && $r_q2 && $r_q3 && $r_q4*/
                            if( $r_insert_p_abs){
