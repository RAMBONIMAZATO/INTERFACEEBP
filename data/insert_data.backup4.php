                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <?php  
                        ...
                        if (isset($_POST['btn_pourcentage'])) {
                            ...
                            SELECT DISTINCT DeptId as DeptId, DeptCode as Code, DeptEff as Effectif, Dates, COUNT( UserId ) as Nb_pres , 
                            (DeptEff-COUNT(distinct(UserId))) as Nb_abs, ((DeptEff-COUNT(distinct(UserId)))*100/DeptEff) as p_abs
							...
							(((COUNT(UserId))*100)/Effectif) as p_abs FROM  `t_absence_jours` WHERE Dates=DATE(NOW()) GROUP BY DeptId";*/
                            $insert_p_abs="INSERT INTO `t_abs`(DeptId, Code, Effectif, Dates, Nb_pres, Nb_abs, p_abs)
...
############################################ HEURES NIGHT SHIFT###################################################################################
                    if (isset($_POST['btn_night_shift'])) {
                        ...
                        $q2= "UPDATE t_h_nuit SET Pause='00:00:00' WHERE Dates='$DateBegin'";
                        $r_q2 = mysqli_query($connection, $q2);
                        
                        $q3="UPDATE t_h_nuit SET P_entree='22:00:00' WHERE Dates='$DateBegin'";
                    ...
                    <div class="row">       
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" action="insert_data.backup4.php" method="post">
                                        <label>Debut : </label>
