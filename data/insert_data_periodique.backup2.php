                    ...
                    <?php  
                        ...
                        if (isset($_POST['btn_journalier'])) {
                            ...
                            $q_retard_journalier = "
                                ...
                                WHERE ((Dates='$txtStartDate' ) AND (Code!='ADMJ')AND (Code!='GNRJ') AND (H_E BETWEEN  '07:05:00' AND  '10:00:00'))
                                UNION DISTINCT
                                SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, Dates, H_E
                                FROM  `t_heures_journalier` 
                                WHERE ((Dates='$txtStartDate' ) AND ( Code='ADMJ' ) AND (H_E BETWEEN  '08:05:00' AND  '10:00:00'))
                                UNION DISTINCT
                                SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, Dates, H_E
                                FROM  `t_heures_journalier` 
                                WHERE ((Dates='$txtStartDate' ) AND (Code='GNRJ') AND (H_E BETWEEN  '06:05:00' AND  '10:00:00'))";
                            ...
                            $q_update_journalier = "
                                ...
                                CASE
                                   ...
                                   ELSE '07:00:00'
                                END),
                                H_Ret=abs(TIMEDIFF(H_E, P_E))  WHERE Dates='$txtStartDate'";
                            ...
                            $q_pourcentage_retard_journalier = "
                                ...
                                FROM t_retard_journalier WHERE Dates='$txtStartDate' GROUP BY DeptId";
                            ...
                            $q_absence_journalier = "
                                ...
                                SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, '$txtStartDate' AS Dates
                                FROM t_dept_journalier 
                                WHERE UserId NOT IN (SELECT DISTINCT UserId FROM t_presence_journalier WHERE Dates = '$txtStartDate'";
                            ...
                            $q_pourcentage_absence_journalier = "
                                ...
                                FROM  `t_presence_journalier` WHERE Dates='$txtStartDate' GROUP BY DeptId ";
                            ...
                            $insert_l_ret="
                                    ...
                                    SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, Dates, H_E
                                    FROM  `t_pres_h_jours` 
                                    WHERE ((Dates='$txtStartDate') AND (Code != 'ADM')AND (Code != 'GNR') AND (H_E BETWEEN  '07:05:00' AND  '10:00:00'))
                                    UNION DISTINCT
                                    SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, Dates, H_E
                                    FROM  `t_pres_h_jours` 
                                    WHERE ((Dates='$txtStartDate') AND ( Code ='ADM' ) AND (H_E BETWEEN  '08:05:00' AND  '10:00:00'))
                                    UNION DISTINCT
                                    SELECT DISTINCT UserId, Name, DeptId, Code, Effectif, Dates, H_E
                                    FROM  `t_pres_h_jours` 
                                    WHERE ((Dates='$txtStartDate') AND (Code ='GNR') AND (H_E BETWEEN  '06:05:00' AND  '10:00:00'))
                                    ";
                            ...
                            $pourcentage_retard_permanant = "
                                            ...
                                            SELECT  DISTINCT DeptId, Code, Effectif, count(UserId) as Nb_ret, (count(UserId)*100/Effectif) AS P_ret, Dates 
                                            FROM t_retard_jours WHERE Dates='$txtStartDate' GROUP BY DeptId
                                            ";
                        ...
                        if (isset($_POST['btn_pourcentage'])) {
                            ...
                            /*$insert_p_abs="INSERT INTO `t_abs`(DeptId, Code, Effectif, Dates, Nb_pres, Nb_abs, p_abs) 
                                    ...
                                    FROM  `t_present_jours` WHERE Dates ='$EndDate' GROUP BY DeptId 
                                ";*/
                            $insert_p_abs="INSERT INTO `t_abs`(DeptId, Code, Effectif, Dates, Nb_pres, Nb_abs, p_abs)
                            SELECT DISTINCT u.DeptId AS DeptId, u.Code AS Code, u.Effectif AS Effectif,(CASE WHEN p.Dates IS NULL THEN '$EndDate' ELSE p.Dates END), 
                            ...
                            FROM t_dept u LEFT JOIN t_present_jours p ON u.DeptId = p.DeptId AND p.Dates='$EndDate' GROUP BY u.DeptId";
                            ...
                            $q_travail_employee="INSERT INTO t_h_travail(UserId, Name, Fonction, DeptId, Code, Effectif, Dates, H_entree, H_sortie, P_entree, P_sortie, H_travail)
                                ...
                                END) AS P_sortie,
                                H_travail
                                FROM t_h_e_s WHERE Dates='$StartDate'
                                ";
                            ...
                            $q_update_entree_sortie=" UPDATE t_h_travail 
                                        ...
                                        WHERE SIGN(TIMEDIFF(H_entree, P_entree))>0 AND Dates='$StartDate'
                                        ";
                            ...
                            /**/
                            $q_update_pause=" UPDATE t_h_travail SET Pause=(CASE WHEN H_entree!=H_sortie THEN '00:45:00' END) WHERE Dates='$StartDate'";
                            $r_q_update_pause = mysqli_query($connection, $q_update_pause);

                            $q_update_travail_pause=" UPDATE t_h_travail SET H_travail=TIMEDIFF(H_travail, Pause) WHERE Dates='$StartDate'";
