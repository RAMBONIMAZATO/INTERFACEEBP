...
<head>
    ...
    <title>Pourcentage retard permanant</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="table-responsive">
                ...
                <table id="table_data" class="table table-striped table-bordered second" style="text-align: center;">
                    ...
                    <?php
                        ...
                        $q_sum = "
                                SELECT sum(Effectif) AS T_Eff, sum(Nb_ret) AS T_ret, ROUND(sum(Nb_ret)*100/sum(Effectif), 2) AS T_p FROM t_pourcentage_retard WHERE (Dates=Date(now()) AND Code!='STC')";
