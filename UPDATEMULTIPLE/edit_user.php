...
if(isset($_POST["save"]) && $_POST["save"]!="") {
	...
	for($i=0;$i<$usersCount;$i++) {
		$query="UPDATE t_sous_dept set Name='" . $_POST["Name"][$i] . "', Fonction='" . $_POST["Fonction"][$i] . "', Code='" . $_POST["Code"][$i] . "'
				...
				<div class="table-responsive">
					<table id="table_data" class="table table-striped table-bordered second" style="text-align: center;">
						...
						<?php
							...
							$result = mysqli_query($connection, "SELECT * FROM t_sous_dept WHERE UserId='" . $_POST["users"][$i] . "'");
						...
						<tr>
							...
							<td><input type="text" name="Fonction[]" class="txtField" value="<?php echo $row[$i]['Fonction']; ?>"></td>
